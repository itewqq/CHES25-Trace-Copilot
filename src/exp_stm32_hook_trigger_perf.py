...
if __name__ == "__main__":
    ...
    bin_path = bin_path + "/cbmxecdsa.bin" # mbedtls
    # bin_path = bin_path + "/wolfssl2.bin" # wolfssl
    ...
    with open(f"../binaries/cbmxecdsa.bin.cfg.json", "r") as f:
    # with open(f"../binaries/wolfssl2.bin.cfg.json", "r") as f:
        import json
