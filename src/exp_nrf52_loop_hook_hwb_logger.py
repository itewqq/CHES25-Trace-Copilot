...
if __name__ == "__main__":
    ...
    mcpu = "cortex-m4"
    compile_options = ""
    p = PIFER(bin_path=bin_path, img_base_va=img_base, arch=mcpu, compile_options=compile_options, template_name='template_string_hwb_addr_tracer')
    ...
    # empty hookers, we only need the breakpoint to be togethered
    reset_hook = '''
    '''
